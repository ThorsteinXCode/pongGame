...
let ballTimerId
scoreDisplay.innerHTML = ('AI Bot 1 ' + score1 + ' - ' + score2 + ' AI Bot 2') 
...
function moveStick1(){
  ...
  if(currentStick1Position[1] < ballCurrentPosition[1] ) {
    currentStick1Position[1] += 20
...
function moveStick2(){
        ...
        if(currentStick2Position[1] < ballCurrentPosition[1] ) {
